...
var fns = require('@react-18-pdf/fns');
var P = require('@react-18-pdf/primitives');
var stylesheet = require('@react-18-pdf/stylesheet');
var layoutEngine = require('@react-18-pdf/textkit/lib/layout');
var linebreaker = require('@react-18-pdf/textkit/lib/engines/linebreaker');
var justification = require('@react-18-pdf/textkit/lib/engines/justification');
var scriptItemizer = require('@react-18-pdf/textkit/lib/engines/scriptItemizer');
var wordHyphenation = require('@react-18-pdf/textkit/lib/engines/wordHyphenation');
var decorationEngine = require('@react-18-pdf/textkit/lib/engines/textDecoration');
var fromFragments = require('@react-18-pdf/textkit/lib/attributedString/fromFragments');
var _createClass = require('@babel/runtime/helpers/createClass');
var pdfkit = require('@react-18-pdf/pdfkit');
var _asyncToGenerator = require('@babel/runtime/helpers/asyncToGenerator');
var _regeneratorRuntime = require('@babel/runtime/regenerator');
var _extends = require('@babel/runtime/helpers/extends');
var emojiRegex = require('emoji-regex');
var resolveImage = require('@react-18-pdf/image');
var flatten = require('@react-18-pdf/stylesheet/lib/flatten');
var Yoga = require('@react-18-pdf/yoga');
var _objectWithoutPropertiesLoose = require('@babel/runtime/helpers/objectWithoutPropertiesLoose');
var advanceWidth = require('@react-18-pdf/textkit/lib/attributedString/advanceWidth');
...
var linebreaker__default = /*#__PURE__*/_interopDefaultLegacy(linebreaker);
var justification__default = /*#__PURE__*/_interopDefaultLegacy(justification);
var scriptItemizer__default = /*#__PURE__*/_interopDefaultLegacy(scriptItemizer);
var wordHyphenation__default = /*#__PURE__*/_interopDefaultLegacy(wordHyphenation);
var decorationEngine__default = /*#__PURE__*/_interopDefaultLegacy(decorationEngine);
var fromFragments__default = /*#__PURE__*/_interopDefaultLegacy(fromFragments);
...
var advanceWidth__default = /*#__PURE__*/_interopDefaultLegacy(advanceWidth);
...
var engines$1 = {
  linebreaker: linebreaker__default["default"],
  justification: justification__default["default"],
  scriptItemizer: scriptItemizer__default["default"],
  wordHyphenation: wordHyphenation__default["default"],
  fontSubstitution: fontSubstitution,
  textDecoration: decorationEngine__default["default"]
};
...
var getAttributedString$1 = function getAttributedString(fontStore, instance) {
  return fromFragments__default["default"](getFragments$1(fontStore, instance));
};
...
/**
 * Resolves `src` to `@react-18-pdf/image` interface.
 *
...
var resolvePageStyles = function resolvePageStyles(page) {
  ...
  var container = _extends__default["default"]({}, box, {
    dpi: dpi
  });
...
var resolvePageSize = function resolvePageSize(page) {
  ...
  var style = flatten__default["default"](page.style || {});
...
var createInstance = function createInstance(element) {
  ...
  var nextChildren = fns.castArray(children).map(createInstance);
  return {
    type: type,
    style: style,
    props: props,
...
var getAttributedString = function getAttributedString(fontStore, instance) {
  ...
  return fromFragments__default["default"](fragments);
};
...
var linesWidth = function linesWidth(node) {
  ...
  return Math.max.apply(Math, [0].concat(node.lines.map(function (line) {
    return advanceWidth__default["default"](line);
  })));
};
