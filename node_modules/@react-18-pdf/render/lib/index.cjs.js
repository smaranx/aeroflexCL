...
var advanceWidth = require('@react-18-pdf/textkit/lib/run/advanceWidth');
var lineWidth = require('@react-18-pdf/textkit/lib/attributedString/advanceWidth');
var absPath = require('abs-svg-path');
var parsePath = require('parse-svg-path');
var normalizePath = require('normalize-svg-path');
var runHeight = require('@react-18-pdf/textkit/lib/run/height');
var runDescent = require('@react-18-pdf/textkit/lib/run/descent');
var ascent = require('@react-18-pdf/textkit/lib/attributedString/ascent');
...
var lineWidth__default = /*#__PURE__*/_interopDefaultLegacy(lineWidth);
...
var runHeight__default = /*#__PURE__*/_interopDefaultLegacy(runHeight);
var runDescent__default = /*#__PURE__*/_interopDefaultLegacy(runDescent);
var ascent__default = /*#__PURE__*/_interopDefaultLegacy(ascent);
...
var renderRun$1 = function renderRun(ctx, run) {
  var runAdvanceWidth = advanceWidth__default["default"](run);
...
var renderSpan = function renderSpan(ctx, line, textAnchor, dominantBaseline) {
  ...
  var width = lineWidth__default["default"](line);
...
var renderRun = function renderRun(ctx, run, options) {
  ...
  var height = runHeight__default["default"](run);
  var descent = runDescent__default["default"](run);
  var runAdvanceWidth = advanceWidth__default["default"](run);
...
var renderLine = function renderLine(ctx, line, options) {
  var lineAscent = ascent__default["default"](line);
  ...
  for (var i = 0; i < line.runs.length; i += 1) {
    ...
    if (run.attributes.backgroundColor) {
      ...
      var backgroundRect = {
        ...
        width: advanceWidth__default["default"](run) - overflowRight
      };
