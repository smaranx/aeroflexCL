...
## How to install
```sh
yarn add @react-18-pdf/render
```

## How it works

```js
const render = require('@react-18-pdf/render');
const primitives = require('@react-18-pdf/primitives');
...
Mandatory field specifiying the type of the particular node. The full list of types can be found and imported from `@react-18-pdf/primitives`
...
const fs = require('fs');
const render = require('@react-18-pdf/render');
const pdfkit = require('@react-18-pdf/pdfkit');
